...
ALTER TABLE REPORT ADD COMMENT_NO NUMBER;

ALTER TABLE CONSULT MODIFY RESPONDENTS NULL;

ALTER TABLE CONSULT ADD ANSWER_STATUS VARCHAR2(50 BYTE) DEFAULT '미답변' NOT NULL;

COMMENT ON COLUMN CONSULT.ANSWER_STATUS IS '답변/미답변';

ALTER TABLE REVIEW ADD STATUS VARCHAR2(10) DEFAULT 'Y' NOT NULL;

COMMENT ON COLUMN REVIEW.STATUS IS 'STATUS';

ALTER TABLE TB_CART RENAME COLUMN pro_no2 TO pro_no; 
