...
<body>
	<%@ include file="../common/userMenubar.jsp"%>
            ...
            <div class="insertform" id="">
              ...
              <p align="center"><input type="checkbox" id="agree_all" name="agree_all"> 이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</p>
              <br> <hr style="border: 0.5px solid rgb(206, 206, 206); width: 900px; margin: auto;">
                <form action="" id="joinForm">
                    <div class="join_box" style=" text-align: center;"> 
                        <div class="check_Box" align="center">
                            <label>[필수] 이용약관 동의<input type="checkbox" name="agree" id="termsOfService"></label>
                ...
                ①“몰” 이란 도그푸드 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.  </textarea>
                        ...
                        <div class="check_Box" align="center">
                            <label>[필수] 개인정보 수집 및 이용 동의<input type="checkbox" name="agree" id="privacyPolicy"></label>
                ...
                ο 개인정보 수집방법 : 홈페이지(회원가입) , 서면양식 </textarea>
                        ...
                        <div class="check_Box" align="center">
                            <label>[선택] 쇼핑정보 수신 동의<input type="checkbox" name="agree" id="allowPromotions"></label>
                ...
                단, 주문/거래 정보 및 주요 정책과 관련된 내용은 수신동의 여부와 관계없이 발송됩니다.</textarea>
                        ...
                        <input type="submit" value="회원가입" id="join_btn" style=" display: inline-block;" disabled>
                    </div>
                </form>
